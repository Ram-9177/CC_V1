...
# Must match production (gunicorn hostelconnect.asgi:application): ws/main/, JWT query auth, full channel routes.
# core.asgi only exposed ws/core/ — the SPA expects /ws/main/ and would fail every connect under runserver.
...
_default_cors_allowed_origins = [
    ...
    "http://localhost:3000",
    "http://localhost:5173",
    # Same dev servers via loopback hostname (browsers treat this as a different site than "localhost")
    "http://127.0.0.1:3000",
    "http://127.0.0.1:5173",
]
