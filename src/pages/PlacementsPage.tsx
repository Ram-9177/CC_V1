...
export default function PlacementsPage() {
  ...
  return (
    <div className="page-frame mx-auto min-w-0 w-full max-w-6xl pb-6">
      <div className="page-hero-card mb-4 sm:mb-5">
        <div className="flex min-w-0 items-center gap-3">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary/10">
            <Briefcase className="h-5 w-5 text-primary" />
          </div>
          <div className="min-w-0">
            <h1 className="page-title text-2xl">Career Placements</h1>
            <p className="page-lead mt-0 text-sm">Company listings, job applications & placement outcomes</p>
          </div>
        </div>
      </div>
          ...
          <div className="w-full md:w-fit">
            <div className="md:hidden relative">
              <select
                ...
                className="w-full appearance-none rounded-lg border-2 border-primary/20 bg-card p-3 pr-10 text-[13px] font-black uppercase tracking-widest text-foreground shadow-sm transition-all focus:border-primary focus:ring-2 focus:ring-primary"
              >
              ...
              return (
                <div key={app.id} className="bg-card rounded-xl border border-border shadow-sm p-4 flex gap-3 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    {app.feedback && <p className="mt-2 rounded border border-border bg-muted/50 p-2 text-xs text-muted-foreground">{app.feedback}</p>}
