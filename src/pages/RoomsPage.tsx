...
export default function RoomsPage() {
  ...
  if (isStudentSelfView) {
    return (
      <div className="page-frame mx-auto min-w-0 w-full max-w-4xl space-y-3 sm:space-y-4 pb-6">
        <SEO
          title="My Room"
  ...
  return (
    <div className="page-frame min-w-0 w-full space-y-3 sm:space-y-4 overflow-x-hidden pb-6">
      <SEO 
