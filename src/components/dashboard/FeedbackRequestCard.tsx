  ...
  return (
    <>
            ...
            <CardContent className="p-0">
              <div className="p-4 flex items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-primary rounded-sm text-foreground group-hover:rotate-12 transition-transform">
                ...
                <Button 
                  className="bg-primary hover:bg-primary/90 text-foreground font-black rounded-sm h-12 px-6 shadow-lg shadow-primary/20"
      ...
      <Dialog open={!!popupMeal} onOpenChange={(open) => { if (!open && popupMeal) handleDismiss(popupMeal.id); }}>
        <DialogContent className="sm:max-w-md w-[95vw] max-h-[90vh] overflow-y-auto p-0 border-none bg-white rounded text-black">
          {/* Vibrant header */}
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="resize-none h-28 rounded-sm border-0 bg-gray-50 focus-visible:ring-primary p-4"
              />
            </div>
          </div>
          ...
          <div className="px-6 pb-6 flex gap-3">
            ...
            <Button
              ...
              className="flex-1 h-12 rounded-sm font-black primary-gradient text-white shadow-lg shadow-primary/20"
            >
