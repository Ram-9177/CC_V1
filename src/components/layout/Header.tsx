...
function Header({ setSidebarOpen }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-primary/[0.08] bg-card/80 text-foreground shadow-[0_12px_40px_-20px_hsl(var(--primary)/0.18)] backdrop-blur-xl transition-all dark:border-border dark:bg-background/90 dark:shadow-sm">
      <div className="grid h-14 items-center gap-2 px-4 sm:px-6 grid-cols-[1fr_auto] xl:grid-cols-[auto_1fr_auto]">
        ...
        <div
          ...
          aria-hidden
        >
          <div className="rounded-xl border border-primary/10 bg-gradient-to-r from-primary/[0.06] via-muted/40 to-[hsl(var(--pastel-blue)_/_0.35)] px-2.5 py-1 shadow-inner shadow-primary/5 dark:border-border/60 dark:from-muted/20 dark:via-muted/30 dark:to-muted/20">
            <NavbarAccentIllustration className="opacity-[0.85] max-w-[min(160px,26vw)]" />
          </div>
        </div>
