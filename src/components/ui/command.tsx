    ...
    <Dialog {...props}>
      <DialogContent className="overflow-hidden p-0 shadow-lg">
        ...
        <DialogDescription className="sr-only">
          Type to filter pages and actions. Use arrow keys to move, Enter to select, Escape to close.
        </DialogDescription>
  ...
  return (
    <div className="flex items-center border-b px-3" cmdk-input-wrapper="">
      ...
      <CommandPrimitive.Input
        ...
        name={controlName}
        className={cn(
          "flex h-11 w-full rounded-sm bg-transparent py-3 text-sm outline-none placeholder:text-stone-400 placeholder:font-medium disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        {...props}
      />
