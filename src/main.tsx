...
// Default is always light (white) unless the user explicitly chose dark in the UI.
...
const OfflineBanner = () => {
  ...
  return (
    <div className="fixed left-0 right-0 top-0 z-[9999] flex items-center justify-center gap-2 bg-destructive py-2 text-center text-sm font-bold text-destructive-foreground shadow-md">
